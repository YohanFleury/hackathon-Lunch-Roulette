...
const RouletteLunch = () => {
    ...
    const [firstBtnSelected, setfirstBtnSelected] = useState(false)
    const [secondBtnSelected, setsecondBtnSelected] = useState(false)
    const [thirdBtnSelected, setthirdBtnSelected] = useState(false)
    const [fourthBtnSelected, setfourthBtnSelected] = useState(false)
        ...
        <div>
            ...
            <div className="buttons_div">
                ...
                <div className="white_button_div">
                    <button onClick={() => setfirstBtnSelected(!firstBtnSelected)} className={firstBtnSelected ? "dark_button" : "white_button"}><p>Ah, mince, il pleut! </p><img src={parapluie} alt="" /> </button>
                    <button onClick={() => setsecondBtnSelected(!secondBtnSelected)} className={secondBtnSelected ? "dark_button" : "white_button"}>Y'a Coline... sans gluten</button>
                    <button onClick={() => setthirdBtnSelected(!thirdBtnSelected)} className={thirdBtnSelected ? "dark_button" : "white_button"}><p>Végétarien... </p><img src={past} alt="" /><p>(pas steack)</p></button>
                    <button onClick={() => setfourthBtnSelected(!fourthBtnSelected)} className={fourthBtnSelected ? "dark_button" : "white_button"}><p>Vegan </p><img src={lapin} alt="" />  </button>
                </div>
